...
def Build_Character_Encoder():
    ...
    keyList = CharList1 + CharList2
    valueList = CodeList1 + CodeList2
    CodeList3 = ".-.-.-"
    
    for i in range(len(keyList)):
        Character_Encoder[keyList[i]] = valueList[i]
        
    for i in range(len(CharList3)):
        Character_Encoder[CharList3[i]] = CodeList3
...
def Build_Character_Decoder():
    ...
    for i in range(len(valueList)):
        Character_Decoder[valueList[i]] = keyList[i]
        
    Character_Decoder[CodeList3] = '#'
...
def Word_Encoder(Word, Character_Encoder=None):
    ...
    for i in Word:
        i = i.lower()
        Word_in_Morse_Code.append(Character_Encoder[i])
    
    Word_in_Morse_Code = ' '.join(Word_in_Morse_Code)
...
def Word_Decoder(Word_in_Morse_Code, Character_Decoder=None):
    ...
    Word = ''
    for i in Word_in_Morse_Code.split():
...
def Message_Encoder(Message, Character_Encoder=None):
    ...
    for i in words:
        i = Word_Encoder(i, Character_Encoder)
        Message_in_Morse_Code.append(i)
...
def Message_Decoder(Message_in_Morse_Code, Character_Decoder=None):
    ...
    for i in words:
        i = Word_Decoder(i, Character_Decoder)
        Message.append(i)
